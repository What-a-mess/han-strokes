...
class GridRenderer:
    ...
    def __init__(self, grid_colors: List[str] = ["grey"] * 4, grid_dasharray: List[str] = ["3 3"] * 4, grid_width: List[int] = [0.5] * 4):
        self.BASE_HEIGHT = 100
        self.grid_colors = grid_colors
        self.grid_dasharray = grid_dasharray
    ...
    def get_background_path(self) -> str:
        ...
        for idx, path in enumerate(paths):
            svg_path = background_path_template.format(
                ...
                dasharray=self.grid_dasharray[idx],
            )
